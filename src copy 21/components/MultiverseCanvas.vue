...
.side-panel.glitch-mode {
  ...
  animation: panel-shake 0.15s infinite !important;
...
.glitch-mode .desc, 
.glitch-mode label, 
.glitch-mode .stat-item span {
  color: #ff3333 !important;
  text-shadow: 2px 0 #00ff41, -2px 0 #fff !important;
  animation: text-glitch 0.3s infinite !important;
}
...
@keyframes panel-shake {
  ...
  100% { transform: translate(1.5px, 3px); }
}
