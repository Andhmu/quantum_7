...
.quantum-monitor { 
  ...
  .side-panel { 
    ...
    top: auto; 
    width: 100%; 
    /* Добавляем 15px базы + системный отступ устройства */
    padding: 6px 12px calc(15px + env(safe-area-inset-bottom)); 
    border-radius: 0; 
    ...
    /* height: 84px; Фиксируем высоту для точной стыковки */
        height: auto; /* Убираем жесткую высоту, пусть растет от паддинга */
  }
