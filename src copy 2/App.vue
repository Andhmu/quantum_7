...
@media screen and (max-width: 768px) {
  .observer-interface {
    padding: 0; /* Убираем падинги, чтобы элементы прилипали к краям */
  }
  ...
  .hud-header {
    ...
    left: 0;
    width: 100%;
    height: 30px; /* Фиксируем высоту шапки */
    padding: 0 10px;
    box-sizing: border-box;
    display: flex;
    align-items: center;
    background: rgba(0, 0, 0, 0.9); /* Плотный фон, чтобы не сливалось */
    z-index: 100; /* Самый высокий слой */
    border-bottom: 1px solid rgba(0, 255, 65, 0.5);
  }

  .hud-header h1 {
    font-size: 8px; /* Чуть меньше, чтобы влезло */
  }
