...
.blur-bg { filter: blur(8px) grayscale(0.4); }
...
.intro-window {
  width: 600px; background: rgba(255, 255, 255, 0.07);
...
.scientific-text {
  ...
  margin-bottom: 35px; border-left: 1px solid #00ff41; padding-left: 25px;
  max-height: 380px; overflow-y: auto; text-align: justify;
}
.scientific-text strong { color: #00ff41; font-weight: normal; text-transform: uppercase; }
.scientific-text p { margin-bottom: 15px; }
.warning { color: #ff3333; font-weight: bold !important; border-top: 1px solid rgba(255,51,51,0.2); padding-top: 10px; }

.launch-btn {
  width: 100%; background: transparent; border: 1px solid #00ff41;
  color: #00ff41; padding: 18px; font-family: inherit; font-size: 12px;
  cursor: pointer; transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); letter-spacing: 4px;
}
.launch-btn:hover { background: #00ff41; color: #000; box-shadow: 0 0 30px rgba(0, 255, 65, 0.4); }

/* ПРАВАЯ ПАНЕЛЬ И ГЛИТЧ */
.side-panel {
