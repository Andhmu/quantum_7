    ...
    <div class="quantum-monitor">
      ...
      <div class="stat-group">
        <div class="entry">
          ...
          <span class="val">{{ store.collapseCount }}</span>
        </div>
        <div class="entry">
          <label>CONTINUOUS_EXISTENCE</label>
          <span class="val">{{ formatTime(store.continuousTime) }}</span>
        </div>
      </div>
      ...
      <div class="awareness-container">
        <div class="label-row">
          ...
          <span>{{ store.awareness }}%</span>
        </div>
        <div class="progress-track">
          <div class="progress-fill" :style="{ width: store.awareness + '%' }"></div>
        </div>
